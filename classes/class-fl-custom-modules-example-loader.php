...
class FL_Custom_Modules_Example_Loader {
	...
	static public function load_modules() {
		...
		require_once FL_MODULE_EXAMPLES_DIR . 'modules/red-button/red-button.php';
		require_once FL_MODULE_EXAMPLES_DIR . 'modules/usc-white-background-button/usc-white-background-button.php';
		require_once FL_MODULE_EXAMPLES_DIR . 'modules/red-gallery/red-gallery.php';
	}
	...
	static public function register_fields( $fields ) {
		...
		$fields['red-checkbox'] = FL_MODULE_EXAMPLES_DIR . 'fields/red-checkbox.php';
		return $fields;
	}
