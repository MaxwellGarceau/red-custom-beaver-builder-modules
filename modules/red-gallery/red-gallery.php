...
/**
 * @class RED_FLGalleryModule
 */
class RED_FLGalleryModule extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(array(
			'name'            => __( 'RED Gallery', 'fl-builder' ),
			'description'     => __( 'Red Earth Designs modified photo gallery.', 'fl-builder' ),
		...
		// require_once FL_MODULE_EXAMPLES_URL . '/red-gallery/includes/red-download-trigger.php';
	}
 ...
 */
FLBuilder::register_module('RED_FLGalleryModule', array(
	'general' => array(
			...
			'general' => array(
				...
				'fields' => array(
					...
					'download_link_text' => array(
						'type'    => 'text',
						'label'   => __( 'Download Link Text', 'fl-builder' ),
						'default' => 'Download',
					),
				),
			),
