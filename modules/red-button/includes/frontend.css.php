...
if ( ! empty( $settings->border_hover_color ) ) {
...
.fl-builder-content .fl-node-<?php echo $id; ?> a.fl-button:visited {
	...
	<?php else: ?>
		...
		<?php // If background color is unset and transparent is selected ?>
		<?php if ( 'transparent' == $settings->style ) : // Transparent ?>
...
<?php if ( ! empty( $settings->border_hover_color ) ) : // Border Hover Color ?>
.fl-builder-content .fl-node-<?php echo $id; ?> a.fl-button:hover,
.fl-builder-content .fl-node-<?php echo $id; ?> a.fl-button:focus {
	...
	<?php if ( 'transparent' == $settings->style ) : // Transparent ?>
		border: <?php echo $border_size; ?>px solid rgba(<?php echo implode( ',', FLBuilderColor::hex_to_rgb( $settings->border_hover_color ) ) ?>, <?php echo $settings->bg_hover_opacity / 100; ?>);
	<?php endif; ?>
}
<?php endif; ?>
