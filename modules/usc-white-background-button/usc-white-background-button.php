...
/**
 * @class FLUSCWhiteBackgroundButtonModule
 */
class FLUSCWhiteBackgroundButtonModule extends FLBuilderModule {
 ...
 */
FLBuilder::register_module('FLUSCWhiteBackgroundButtonModule', array(
	'general'       => array(
